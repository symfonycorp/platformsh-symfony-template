...
<details>
<summary>Symfony: using Symfony Server</summary>
Please follow steps described <a href="https://symfony.com/doc/current/setup/symfony_server.html">in the doc</a>

> **Note:**</BR>
> This template include a docker container for using PostgreSQL 14, that you can run using `docker-compose up -d`

</details>
<details>
<summary>Symfony: using DDEV</summary>
...
1. Within your Symfony project folder, run `cp .env .env.local`.
