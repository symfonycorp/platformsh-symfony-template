...
<h1 align="center">Deploy Symfony for Platform.sh</h1>
...
This section provides instructions for running the `Symfony` template locally, connected to a live database instance on an active Platform.sh environment.
...
> **Note:**
>
> This template include a docker container for using Postgres 13, that you can run using `docker-compose up -d`
